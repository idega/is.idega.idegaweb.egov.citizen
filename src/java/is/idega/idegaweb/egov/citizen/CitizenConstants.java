...
public class CitizenConstants {
	public static final String IW_BUNDLE_IDENTIFIER = "is.idega.idegaweb.egov.citizen";
	public static final String NEEDED_SCRIPT_AND_STYLE_FILES = "needed_script_and_style_files";
	public static final String False = "false";
	// User edit parameters
	public static final String USER_EDIT_NAME_PARAMETER = "user-edit-name-parameter";
